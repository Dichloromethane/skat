...
CFLAGS=-std=gnu17 -O0 -ggdb3 -fasynchronous-unwind-tables -fsanitize=thread #-fsanitize=address
...
bear:: clean
bear:: | $(BUILDDIRS)
	bear --output $(COMP_COMMANDS) -- $(MAKE) all_ || bear -o $(COMP_COMMANDS) $(MAKE) all_
